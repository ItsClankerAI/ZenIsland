...
var LASTFM_AUTHORIZE_URL = "https://api.supercmd.sh/auth/lastfm/authorize?app=zenisland";
...
function setupStatusCard() {
  ...
  if (pending) {
    ...
    subtitle = "Finish the approval in your browser. ZenIsland will connect automatically.";
...
function mediaBridgeStatusView() {
  return View.frame(
    View.vstack([
      ...
      View.text("Playback data is temporarily unavailable in this app session. Relaunch ZenIsland to restore the media bridge.", {
        style: "footnote",
