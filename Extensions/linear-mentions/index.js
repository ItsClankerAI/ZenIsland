...
const LINEAR_AUTHORIZE_URL = "https://api.supercmd.sh/auth/linear/authorize?app=zenisland";
...
function fullExpandedView() {
  ...
  if (!oauth.connected) {
    ...
    return View.vstack([
      View.text("Linear Mentions", { style: "title", lineLimit: 1 }),
      View.text(oauth.expired ? "Your saved Linear session expired. Start OAuth again." : "Authorize Linear to receive mentions in ZenIsland.", {
        style: "caption",
        color: "gray",
        lineLimit: 2
      }),
